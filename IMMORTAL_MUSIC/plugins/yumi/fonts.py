...
from IMMORTAL_MUSIC.utils.IMMORTAL_font import Fonts
...
async def style_buttons(c, m, cb=False):
    ...
    buttons = [
        [
            InlineKeyboardButton("ðšƒðš¢ðš™ðšŽðš ðš›ðš’ðšðšŽðš›", callback_data="style+typewriter"),
            InlineKeyboardButton("ð•†ð•¦ð•¥ð•ð•šð•Ÿð•–", callback_data="style+outline"),
            InlineKeyboardButton("ð’ðžð«ð¢ðŸ", callback_data="style+serif"),
        ],
        [
        ...
        buttons = [
            [
                ...
                InlineKeyboardButton(
                    "ðŸ†‚ï¸ŽðŸ†€ï¸ŽðŸ†„ï¸ŽðŸ…°ï¸ŽðŸ†ï¸ŽðŸ…´ï¸ŽðŸ†‚ï¸Ž", callback_data="style+squares_bold"
                ),
            ],
            [
            ...
            [
                ...
                InlineKeyboardButton("ê’’êê€·êŒ©êŒƒê€Žê…", callback_data="style+ladybug"),
            ],
            [
