...
from IMMORTAL_MUSIC import app
from IMMORTAL_MUSIC.utils.IMMORTAL_ban import admin_filter
from IMMORTAL_MUSIC.utils.database import get_assistant
...
async def join_group(client, message):
    ...
    if (
        ...
        try:
            ...
            await done.edit_text(
                f"**âž» á´€á´„á´›á´œá´€ÊŸÊŸÊ Éª Ò“á´á´œÉ´á´… á´›Êœá´€á´› á´Ê á´€ssÉªsá´›á´€É´á´› Êœá´€s É´á´á´› á´Šá´ÉªÉ´ á´›ÊœÉªs É¢Ê€á´á´œá´˜ á´€É´á´… Éª á´€á´ É´á´á´› á´€Ê™ÊŸá´‡ á´›á´ ÉªÉ´á´ Éªá´›á´‡ á´Ê á´€ssÉªsá´›á´€É´á´› Ê™á´‡á´„á´€á´œsá´‡ [ Éª á´…á´É´á´› Êœá´€á´ á´‡  ÉªÉ´á´ Éªá´›á´‡ á´œsá´‡Ê€ á´€á´…á´ÉªÉ´ á´˜á´á´¡á´‡Ê€ ] sá´ á´˜ÊŸá´‡á´€sá´‡ á´˜Ê€á´á´ Éªá´…á´‡ á´á´‡ ÉªÉ´á´ Éªá´›á´‡ á´œsá´‡Ê€s á´€á´…á´ÉªÉ´ á´˜á´á´¡á´‡Ê€ á´›Êœá´‡É´ á´›Ê€Ê á´€É¢á´€ÉªÉ´ Ê™Ê- /userbotjoin.**\n\n**âž¥ Éªá´… Â»** @{userbot.username}"
            )
    ...
    if (
        ...
        if userbot_member.status in [
            ...
            try:
                ...
                await done.edit_text(
                    f"**âž» á´€á´„á´›á´œá´€ÊŸÊŸÊ Éª Ò“á´á´œÉ´á´… á´›Êœá´€á´› á´Ê á´€ssÉªsá´›á´€É´á´› Éªs Ê™á´€É´É´á´‡á´… ÉªÉ´ á´›ÊœÉªs É¢Ê€á´á´œá´˜ á´€É´á´… Éª á´€á´ É´á´á´› á´€Ê™ÊŸá´‡ á´›á´ á´œÉ´Ê™á´€É´ á´Ê á´€ssÉªsá´›á´€É´á´› Ê™á´‡á´„á´€á´œsá´‡ [ Éª á´…á´É´á´› Êœá´€á´ á´‡  Ê™á´€É´ á´˜á´á´¡á´‡Ê€ ] sá´ á´˜ÊŸá´‡á´€sá´‡ á´˜Ê€á´á´ Éªá´…á´‡ á´á´‡ Ê™á´€É´ á´˜á´á´¡á´‡Ê€ á´Ê€ á´œÉ´Ê™á´€É´ á´Ê á´€ssÉªsá´›á´€É´á´› á´á´€É´á´œá´€ÊŸÊŸÊ á´›Êœá´‡É´ á´›Ê€Ê á´€É¢á´€ÉªÉ´ Ê™Ê- /userbotjoin.**\n\n**âž¥ Éªá´… Â»** @{userbot.username}"
                )
        return
...
async def leave_all(client, message):
    ...
    left = 0
    failed = 0
    lol = await message.reply("ðŸ”„ **á´œsá´‡Ê€Ê™á´á´›** ÊŸá´‡á´€á´ ÉªÉ´É¢ á´€ÊŸÊŸ á´„Êœá´€á´›s !")
    try:
        userbot = await get_assistant(message.chat.id)
        ...
        await app.send_message(
            message.chat.id,
            f"**âœ… ÊŸá´‡Ò“á´› Ò“Ê€á´á´:* {left} chats.\n**âŒ Ò“á´€ÉªÊŸá´‡á´… ÉªÉ´:** {failed} chats.",
        )
