...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                if config.SUPPORT_CHANNEL_USERNAME:
                    await self.one.join_chat(config.SUPPORT_CHANNEL_USERNAME)
                else:
        ...
        if config.STRING2:
            ...
            try:
                if config.SUPPORT_CHANNEL_USERNAME:
                    await self.two.join_chat(config.SUPPORT_CHANNEL_USERNAME)
                else:
        ...
        if config.STRING3:
            ...
            try:
                if config.SUPPORT_CHANNEL_USERNAME:
                    await self.three.join_chat(config.SUPPORT_CHANNEL_USERNAME)
                else:
        ...
        if config.STRING4:
            ...
            try:
                if config.SUPPORT_CHANNEL_USERNAME:
                    await self.four.join_chat(config.SUPPORT_CHANNEL_USERNAME)
                else:
        ...
        if config.STRING5:
            ...
            try:
                if config.SUPPORT_CHANNEL_USERNAME:
                    await self.five.join_chat(config.SUPPORT_CHANNEL_USERNAME)
                else:
