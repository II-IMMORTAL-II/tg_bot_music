# =======================================================
# Â©ï¸ 2025-26 All Rights Reserved by Immortal Bots ðŸš€
...
async def get_thumb(videoid):
    ...
    try:
        ...
        arial = ImageFont.truetype("IMMORTAL_MUSIC/assets/font2.ttf", 30)
        font = ImageFont.truetype("IMMORTAL_MUSIC/assets/font.ttf", 30)
        bold_font = ImageFont.truetype("IMMORTAL_MUSIC/assets/font.ttf", 33)

    
        text_size = draw.textsize("TEAM IMMORTAL BOTS", font=font)
        draw.text((1280 - text_size[0] - 10, 10), "TEAM IMMORTAL BOTS", fill="yellow", font=font)
